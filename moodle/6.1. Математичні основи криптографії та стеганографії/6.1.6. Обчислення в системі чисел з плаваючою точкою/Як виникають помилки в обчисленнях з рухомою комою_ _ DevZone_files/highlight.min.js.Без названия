...
begin:/\.$/}]}}})();hljs.registerLanguage("erlang",e)})();/*! `go` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("plaintext",t)})();/*! `protobuf` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("protobuf",e)})();/*! `python` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>{
